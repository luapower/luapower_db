return {
	...
	osx64={
		...
		dollar={
			['$']={
				loaderr='./glue.lua:111: assign to undeclared variable \'ceil\'',
				mdeps={
					bit=true,
					ffi=true,
					glue=true,
		...
		['terra.boxblur']={
			...
			['terra.boxblur']={
				env='terra',
				loaderr='llvm: dlopen(boxblur, 9): image not found',
				mdeps={
					['terra.bitmap']=true,
					['terra.low']=true
				}
		...
		['terra.cairo']={
			['terra.cairo']={
				env='terra',
				loaderr='llvm: dlopen(cairo, 9): image not found',
				mdeps={
					cairo_h=true,
					['terra.low']=true
				}
		...
		['terra.tr']={
			['terra.tr']={
				...
				loaderr='could not create tracking environment: ./terra/low.t:73: llvm: dlopen(cairo, 9): image not found'
			},
			['terra.tr_align']={
				env='terra terra.tr_paint_cairo',
				loaderr='could not create tracking environment: ./terra/low.t:73: llvm: dlopen(cairo, 9): image not found'
			...
			['terra.tr_api']={
				env='terra',
				loaderr='terra/tr_api.t:49: ./terra/low.t:73: llvm: dlopen(cairo, 9): image not found',
				mdeps={
					['terra.memcheck']=true,
					['terra.tr_paint_cairo']=true
				}
			...
			['terra.tr_paint_cairo']={
				env='terra',
				loaderr='./terra/low.t:73: llvm: dlopen(cairo, 9): image not found',
				mdeps={
					['terra.cairo']=true,
					['terra.low']=true
				}
